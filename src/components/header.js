...
const Header = props => {
  ...
  return (
    <header className="block md:flex justify-between">
        ...
        <p className="text-purple-500 mx-auto text-3xl pb-3 md:pb-0 pt-3 font-bold w-5/6 md:w-2/6">JupitersLB Weather App</p>
        <div className="flex mx-auto w-5/6 pt-3 md:w-2/6 justify-end pr-6">
          <form className="w-full max-w-sm" onSubmit={handleSubmit}>
            <div className="flex items-center mb-6">
              <div className="md:w-1/3">
                <label htmlFor="new-search" className="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4">City: </label>
              </div>
